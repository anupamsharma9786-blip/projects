...
exports.Phenotype = void 0;
const mongoose_1 = __importStar(require("mongoose"));
const phenotypeRecordSchema = new mongoose_1.Schema({
    gene: { type: String, required: true },
    diplotype: { type: String, required: true },
    phenotype: { type: String, required: true },
});
const phenotypeSchema = new mongoose_1.Schema({
...
exports.Phenotype = mongoose_1.default.model('Phenotype', phenotypeSchema);
