...
exports.VcfController = void 0;
const VcfService_1 = require("../services/VcfService");
const VariantService_1 = require("../services/VariantService");
const PipelineService_1 = require("../services/PipelineService");
const vcfService = new VcfService_1.VcfService();
const variantService = new VariantService_1.VariantService();
...
class VcfController {
    ...
    async uploadVcf(req, res) {
        try {
            ...
            if (!skipPipeline) {
                console.log(`[VcfController] Executing full pipeline automatically for uploadId: ${uploadRecord.uploadId}${generateReport ? ' with AI report' : ''}`);
                try {
                    const pipelineResult = await pipelineService.executePipeline(uploadRecord.uploadId, generateReport);
                    ...
                    console.error(`[VcfController] Pipeline execution failed: ${errorMessage}`);
                    res.status(201).json({
                        success: true,
...
exports.VcfController = VcfController;
//# sourceMappingURL=VcfController.js.map