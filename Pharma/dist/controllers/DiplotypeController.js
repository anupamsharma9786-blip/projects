...
exports.DiplotypeController = void 0;
const DiplotypeService_1 = require("../services/DiplotypeService");
const VariantUpload_1 = require("../models/VariantUpload");
const Diplotype_1 = require("../models/Diplotype");
const diplotypeService = new DiplotypeService_1.DiplotypeService();
class DiplotypeController {
    /**
     * Process variants and generate diplotypes for a specific upload
     */
    async processDiplotype(req, res) {
        try {
            ...
            // Process diplotypes
            const diplotypes = diplotypeService.processDiplotypes(variantUpload.variants, variantUpload.sampleId);
     ...
     */
    async getSupportedGenes(req, res) {
        try {
...
exports.DiplotypeController = DiplotypeController;
//# sourceMappingURL=DiplotypeController.js.map